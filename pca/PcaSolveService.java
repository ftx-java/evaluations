...
public class PcaSolveService {
    ...
    public double[][] PrincipalComponent(double[][] x, double[][] y, int[] index) {
        ...
        double[][] result = ArrayUtil.arrayMultiplyTwoTwo(y, z);
        ArrayUtil.displayArray(result);
        return result;
    }
    ...
    public static void main(String[] args) {
        double[][] data = {
                {63.5, 2.4, 0.5, 1.6, 5.5, 0.16, 5.9, 9.3, 0.65},
                {86.2, 2.9, 0.64, 2.5, 2.5, 0.12, 4.5, 5, 0.5},
                {78, 2.94, 0.55, 2.3, 3, 0.16, 4, 14.5, 0.6},
                {87, 2.94, 0.54, 2.2, 4, 0.16, 14, 10, 0.75},
                {630, 5.03, 1.2, 2.5, 11, 0.36, 50, 25, 0.8},
                {625, 5.03, 1.2, 2.5, 18, 0.36, 50, 40, 0.8},
                {1000, 5.3, 0.87, 6, 24, 0.41, 100, 70, 0.85},
        };
        PcaSolveService pcaSolveService = new PcaSolveService();
